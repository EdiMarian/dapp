...
var Trim = function Trim(_ref) {
  ...
  return createElement("span", {
    ...
    className: "left"
  }, createElement("span", null, String(text).substring(0, Math.floor(text.length / 2)))), createElement("span", {
    className: "ellipsis"
  }, "..."), createElement("span", {
    className: "right"
  }, createElement("span", null, String(text).substring(Math.ceil(text.length / 2))))) : createElement("span", null, text));
};
