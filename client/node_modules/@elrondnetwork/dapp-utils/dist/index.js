...
var Trim = function Trim(_ref) {
  ...
  return React.createElement("span", {
    ...
    className: "left"
  }, React.createElement("span", null, String(text).substring(0, Math.floor(text.length / 2)))), React.createElement("span", {
    className: "ellipsis"
  }, "..."), React.createElement("span", {
    className: "right"
  }, React.createElement("span", null, String(text).substring(Math.ceil(text.length / 2))))) : React.createElement("span", null, text));
};
...
function calculateFeeLimit(_ref) {
  var minGasLimit = _ref.minGasLimit,
  ...
  var transaction = new erdjs.Transaction({
    ...
    gasPrice: new erdjs.GasPrice(parseInt(gasPrice)),
    gasLimit: new erdjs.GasLimit(parseInt(gasLimit)),
    data: new erdjs.TransactionPayload(data.trim()),
    chainID: new erdjs.ChainID(chainId),
    version: new erdjs.TransactionVersion(1)
  });

  if (!stringIsInteger(gasPerDataByte) && !stringIsFloat(gasPriceModifier) && !stringIsInteger(minGasLimit)) {
