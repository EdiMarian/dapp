...
export declare const transactionsSlice: import("@reduxjs/toolkit").Slice<TransactionsSliceStateType, {
    ...
    clearTransactionToSign: (state: TransactionsSliceStateType, action: PayloadAction<string>) => void;
